...
use sqlx::PgPool;
use mini_webflare::models::order_repo::{OrderRepo, CreateOrder, UpdateOrder, Order};
use mini_webflare::services::order_service;
...
pub async fn delete_order(
    ...
    match mini_webflare::services::order_service::delete_order(&pool, id).await {
